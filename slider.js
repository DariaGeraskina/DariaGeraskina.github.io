const images = [
    '22.png', '33.png', '44.png', '55.png', '66.png', '11.png'
];
...
document.querySelector('.prev-button').addEventListener('click', prevSlide);/*const images = [
...
const prevImageGenerate = (w = felse) => {
    let prevImage = activeImage - 1;
    if (prevImage < 0) prevImage = images.length - 1;
    const img = document.createElement('img');
    img.alt = '';
